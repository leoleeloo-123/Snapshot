...
const translations = {
  en: {
    ...
    hideZeroBalance: 'Hide 0 Balance',
    showZeroBalance: 'Show 0 Balance',
    lend: 'Lend',
    borrow: 'Borrow',
    repay: 'Repay',
    ...
    reviewDatabaseDesc: 'Click the review button in the top right to inspect your current database tables, or upload an Excel file to preview and import new data.',
    openReviewMode: 'Open Review Mode',
    balanceLogs: 'Balance Logs',
    config: 'Config',
    previewingImportData: 'Previewing Import Data',
    previewingImportDataDesc: 'Review the parsed data below. Click confirm to overwrite your current database.',
    confirmImport: 'Confirm Import',
    previewPrefix: 'PREVIEW: ',
    databaseReviewPrefix: 'DATABASE REVIEW: ',
  ...
  zh: {
    ...
    banks: '银行',
    logs: '记录',
    reviewDatabase: '检查数据库',
    reviewDatabaseDesc: '点击右上角的检查按钮以查看您当前的数据库表，或上传 Excel 文件以预览和导入新数据。',
    openReviewMode: '打开检查模式',
    balanceLogs: '余额记录',
    config: '配置',
    previewingImportData: '预览导入数据',
    previewingImportDataDesc: '查看下面解析的数据。点击确认以覆盖您当前的数据库。',
    confirmImport: '确认导入',
    previewPrefix: '预览：',
    databaseReviewPrefix: '数据库检查：',
    closeReview: '关闭检查',
  }
};
